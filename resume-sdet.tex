...
\section{Summary}
\datedline{B.Eng in Computer Engineering, 6+ yrs software test experience, 4+ yrs UI/API Automation Testing, 2+ years in SDET role, looking for Intermediate SDET position.}{}



\section{Skills}
\begin{itemize}[parsep=0.5ex]
  \item Practice: Docker, Kubernetes, AWS, GCP, Jenkins, \textbf{Git}, Maven, Linux, Jira, \textbf{Agile}, HTTP, RESTful API, JSON
...
\begin{itemize}
  ...
  \item Design and develop internal monitoring/testing tools for promotion/customer lifecycle related SaaS products, such as QA benchmarking dashboard, stream data processing system for price/margin forecast, feature toggle management, etc.
...
\datedsubsection{\textbf{Quality Assurance Engineer, Automation}}{06.2016 -- 04.2018}
