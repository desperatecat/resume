...
\section{Summary}
\datedline{B.Eng in Computer Engineering, 6+ yrs software QA experience, 4+ yrs UI/API automation testing, 2+ years in SDET role, looking for Senior Software Engineer in Test position.}{}



\section{Skills}
\begin{itemize}[parsep=0.5ex]
  \item Practice: Docker, AWS, GCP, Jenkins, \textbf{Git}, Maven, Linux, Jira, \textbf{Agile}, HTTP, RESTful API, JSON
  \item Test: \textbf{Selenium}, TestNG, Junit, Jest, \textbf{Postman}, SoapUI, Sumo Logic, JMeter, Locust
  \item Frontend: HTML5, CSS3, Sass, \textbf{JavaScript(ES6)}, Typescript, Bootstrap4, \textbf{React}, \textbf{Redux}, Vue.js
  \item Backend: \textbf{Java}, Spring MVC, \textbf{Spring Boot}, JPA, Python, Node.js, Hibernate, MyBatis, \textbf{MySQL}, PostgreSQL, MongoDB
\end{itemize}


\section{Experience}
\datedsubsection{\textbf{Software Developer in Test}}{04.2020 -- Present}
\role{Genesys Laboratories Canada Inc. (https://www.genesys.com/)}{Toronto, ON}
\begin{itemize}
  \item Responsible for telemetry and test infrastructure, maintain code base to continuously run harnesses functional/load tests for different modules with fully asynchronous Java.
  \item Design and develop internal monitoring/testing tools for promotion/customer lifecycle related SaaS products, such as QA benchmarking dashboard, stream data processing system, feature toggle management, etc.
  \item Implement company-wide AWS QA environments migration leveraging Docker/Kubernetes Ctl, build and improve a data engine platform for testing and validation upon CI pipeline.
...
\datedsubsection{\textbf{Software Engineer in Test}}{07.2018 -- 04.2020}
\role{Rubikloud Technologies (https://rubikloud.com/)}{Toronto, ON}
\begin{itemize}
  \item Participated in business requirements gathering, user workflow identification and story estimation meetings within an Agile Scrum environment, created test strategies/plans/cases.
  ...
  \item Supported production maintenance, conducted periodic bug bashes of 30 participants, resulting in the discovery of, on average, 20\% of total bugs found. Troubleshoot and logged defects in Jira, then verified fixes.
\end{itemize}

\datedsubsection{\textbf{Quality Assurance Engineer, Automation}}{06.2016 -- 05.2018}
