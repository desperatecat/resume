...
\begin{itemize}
  ...
  \item Implement company-wide AWS QA environments migration leveraging Docker/Kubernete Ctl, build and improve a data engine platform for testing and validation upon CI pipeline.
