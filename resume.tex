...
\begin{itemize}
  ...
  \item Conducted End to end testing (UI to DB) including functional, integration, sanity/regression, database test executions. 
  \item Built and refactored UI/API Automation Frameworks based on Java and Selenium Webdriver, converted 70\% manual testing cases to automation scripts.
  \item Executed test scripts through managing jobs with Jenkins, maintained script of cross-browser compatibilities, performed web service/gateway testing by Postman tools and executed performance load testing by JMeter.
