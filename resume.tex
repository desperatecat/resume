...
\begin{itemize}[parsep=0.5ex]
  ...
  \item Backend: Java, Spring Boot, Python, Node.js, Express.js, JPA, Hibernate, MyBatis, Redis, Shiro, MySQL, PostgreSQL, MongoDB
  \item Practice: Docker, Kubernetes, Azure, AWS, GCP, Jenkins, Git, Linux
  \item Test: Jest, Selenium
\end{itemize}
...
\begin{itemize}[parsep=0.5ex]
  \item Website: https://lucasxu.co
  \item GitHub: https://github.com/desperatecat
