...
\begin{itemize}[parsep=0.5ex]
  ...
  \item Backend: \textbf{Java}, Spring MVC, \textbf{Spring Boot}, Python, Node.js, Express.js, JPA, Hibernate, MyBatis, Redis, Shiro, \textbf{MySQL}, PostgreSQL, MongoDB
  \item Practice: Docker, Kubernetes, Azure, AWS, GCP, Jenkins, \textbf{Git}, Maven, Linux, Jira, Agile
