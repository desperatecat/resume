...
\begin{itemize}
  \item Develop testing strategy, create test plans/cases and build test harness/framework for promotion/customer lifecycle related product, log defects and work with developers to troubleshoot and verify fixes.
