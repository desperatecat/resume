...
{https://github.com/desperatecat/DevConnector_MERN_Project}
A MERN(React, Redux, Node.js, Express.js, MongoDB) stack project.
\datedsubsection{\textbf{Project Tasks Management Tools}}{}
{https://github.com/desperatecat/PPMTool_React_Redux_Spring_Project}
A tool build with React + Redux + Spring Boot + JPA + MySQL.
