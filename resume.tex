...
\begin{itemize}
  ...
  \item End to end testing (UI to DB), build and refactor UI/API Automation Frameworks, use DataGrid/Docker/Kubernete Ctl for database testing and validation, improve and build upon CI pipeline.
...
\datedsubsection{\textbf{University of Electronic Science \& Technology of China (UESTC)}, Chengdu, China}{2009 -- 2013}
