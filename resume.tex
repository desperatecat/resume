...
\datedline{A tool build with React + Redux + Spring Boot + JPA + MySQL. It allow user to create project tasks, view and delete tasks. Moreover, user can update these tasks to different stage, i.e., TODO, IN PROGRESS, DONE.}{}
