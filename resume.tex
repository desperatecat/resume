...
\begin{itemize}
  ...
  \item End to end testing (UI to DB), build and re-factor Java Selenium UI/API Frameworks, use DataGrid/Docker/Kubernete Ctl for database testing and validation, improve and build upon CI pipeline.
